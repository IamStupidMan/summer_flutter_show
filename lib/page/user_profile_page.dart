      ...
      child: new RawMaterialButton(
        ...
        child: new Row(
          children: <Widget>[
            ...
            new Icon(SummerIcons.REPOS_ITEM_NEXT, size: 12.0),
          ],
        ),
      ),
    );
...
//      });
  ...
  Widget build(BuildContext context) {
    return new StoreBuilder<SummerState>(builder: (context, store) {
      return Scaffold(
        appBar: new AppBar(
            title: new Hero(
                tag: "home_user_info",
        ...
        body: new Container(
          ...
          child: new SingleChildScrollView(
            child: new Column(
              children: _renderList((store.state.userInfo as User), store),
            ),
          ),
        ),
      );

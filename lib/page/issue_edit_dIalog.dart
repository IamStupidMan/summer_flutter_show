...
import 'package:summerfluttershow/widget/gsy_card_item.dart';
import 'package:summerfluttershow/widget/gsy_input_widget.dart';
                          ...
                          new Container(
                            ...
                            decoration: new BoxDecoration(
                              ...
                              border: new Border.all(
                                  color: SummerColor.subTextColor, width: .3),
                            ),
...
var FAST_INPUT_LIST = [
  FastInputIconModel(SummerIcons.ISSUE_EDIT_H1, "\n# "),
  FastInputIconModel(SummerIcons.ISSUE_EDIT_H2, "\n## "),
  FastInputIconModel(SummerIcons.ISSUE_EDIT_H3, "\n### "),
  FastInputIconModel(SummerIcons.ISSUE_EDIT_BOLD, "****"),
  FastInputIconModel(SummerIcons.ISSUE_EDIT_ITALIC, "__"),
  FastInputIconModel(SummerIcons.ISSUE_EDIT_QUOTE, "` `"),
  FastInputIconModel(SummerIcons.ISSUE_EDIT_CODE, " \n``` \n\n``` \n"),
  FastInputIconModel(SummerIcons.ISSUE_EDIT_LINK, "[](url)"),
];

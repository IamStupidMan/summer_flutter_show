...
import 'package:summerfluttershow/localization/summer_string_base.dart';

import 'gsy_string_en.dart';
import 'gsy_string_zh.dart';
...
class GSYLocalizations {
  ...
  static Map<String, SummerStringBase> _localizedValues = {
    'en': new GSYStringEn(),
    'zh': new GSYStringZh(),
  };

  SummerStringBase get currentLocalized {
  ...
  ///通过 Localizations 加载当前的 GSYLocalizations
  ///获取对应的 GSYStringBase
  static SummerStringBase i18n(BuildContext context) {

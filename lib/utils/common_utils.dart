...
import 'package:summerfluttershow/page/issue_edit_dIalog.dart';
...
//  }
  ...
  static showLanguageDialog(BuildContext context) {
    ...
    CommonUtils.showCommitOptionDialog(context, list, (index) {
      print("index:::$index");
      CommonUtils.changeLocale(StoreProvider.of<SummerState>(context), index);
...
//  }
   ...
   * 切换语言
   */
  static changeLocale(Store<SummerState> store, int index) {
                ...
                child: Center(
                  child: new Container(
                    ...
                    child: new Column(
                      ...
                      children: <Widget>[
                        new Container(
                            child: SpinKitCubeGrid(color: SummerColor.white)),
